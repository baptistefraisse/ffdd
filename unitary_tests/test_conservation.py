""" Unitary test : mass and charge conservation """
...
def test_conservation():
    """Check the charge and mass conservation in neutron-induced fission yields"""
    ...
    for a_target, z_target in nuclei:
        ...
        for nfy in nfy_list:
            ...
            for frag in ff:
                ...
                assert zh + zl == z_target
                assert ah + al == a_target + 1 # incident neutron
